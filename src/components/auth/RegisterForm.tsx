      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <motion.div className="space-y-2" variants={itemVariants}>
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-12 h-11 rounded-xl border-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all"
              disabled={loading}
            />
        ...
        <motion.div variants={itemVariants}>
          <Button
            ...
            className="w-full h-11 rounded-xl font-semibold text-base bg-gradient-to-r from-primary to-accent hover:shadow-lg hover:shadow-primary/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            {loading ? (
              <>
